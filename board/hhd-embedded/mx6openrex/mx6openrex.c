...
static iomux_v3_cfg_t const usb_otg_pads[] = {
	//MX6_PAD_EIM_D22__USB_OTG_PWR | MUX_PAD_CTRL(NO_PAD_CTRL), // OpenRex doesn't have USB PWR EN pin
...
{
	return (bus == 2 && cs == 1) ? (IMX_GPIO_NR(4, 26)) : -1;
}
#endif
